...
As the docs hierarchy matures, repository-wide quirks should stay minimal. Etherscan payload inconsistencies, Helius asset-label caveats, Hyperliquid identifier issues, and pricing caveats should eventually live in their own domain `QUIRKS.md` files.
